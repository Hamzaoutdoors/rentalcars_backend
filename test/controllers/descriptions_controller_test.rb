...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { insurance_fee: @description.insurance_fee, price_daily: @description.price_daily, price_monthly: @description.price_monthly } }, as: :json
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { insurance_fee: @description.insurance_fee, price_daily: @description.price_daily, price_monthly: @description.price_monthly } }, as: :json
    assert_response 200
  end
